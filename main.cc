...
int main() {
  ...
  Vec3 cpMesh = Vec3(-0.8,0.2, 0.5);
  Vec3 laMesh = Vec3(1,0,0);
  Vec3 upMesh = Vec3(0,-1,1);
  Vec3 cpMesh2 = Vec3(0, 2.2, 3);
  Vec3 laMesh2 = Vec3(0,-0.1,-1);
  Vec3 upMesh2 = Vec3(0,1,0);
  PerspectiveCamera cameraP(cp, la, up, 2);
  PerspectiveCamera cameraPMesh(cpMesh, laMesh, upMesh, 2);
  PerspectiveCamera cameraPMesh2(cpMesh2, laMesh2, upMesh2, 2);
